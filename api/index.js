...
mongoose
  .connect(
    "mongodb+srv://bartaTrade:ULwN0zf07F4biIJM@cluster0.f7vpesz.mongodb.net/",
    {
...
const sendVerificationEmail = async (email, verificationToken) => {
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "tinganjeff57@gmail.com",
      pass: "nozejygnknqlxrkz",
    },
  });
...
app.get("/verify/:token", async (req, res) => {
    try {
        ...
        res.status(500).json({ message: "Email verification failed", error: error });
    }
});
